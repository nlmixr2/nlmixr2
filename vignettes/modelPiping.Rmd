...
library(nlmixr2save)
## Cache each fit with the `:=` operator (nlmixr2save): fits are stored under
## vignettes/cache/ with a per-article prefix and loaded as-is on the website
## build.  See the "Contributing a long-running example" article.
