...
Next, for the purpose of this demostrtaion we will subset to 7 patients per dose group):
...
This approach is not only good for demonstration, but allows a variety of
structural models to be applied more quickly while developing a base model. 
The full dataset can then be applied to the selected model to make sure it
makes sense with all the data.
...
sim1 <- simulate(cmt2fit.logn, newdata=ev, nSub=100, nStud=100)
