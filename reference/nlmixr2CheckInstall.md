...
Nothing, called for the side effect of reporting on the installation

## Examples

``` r
nlmixr2CheckInstall()
#> ℹ Operating system: Linux 6.17.0-1022-azure #22-Ubuntu SMP Mon Jul 27 17:24:03 UTC 2026
...
#> ✔ The package 'admixr2' is installed and seems to be up to date, version 0.2.0
...
#> ✔ The package 'monolix2rx' is installed and seems to be up to date, version 0.0.6
...
#> ✔ The package 'xpose.nlmixr2' is installed and seems to be up to date, version 0.4.2
```
