...
Building on the first simple example, we can be more ambitious, and try
a full PBPK model. This one was published for mavoglurant (Wendling et
al. 2016).
...
![](mavoglurant_files/figure-html/saem-1.png)![](mavoglurant_files/figure-html/saem-2.png)![](mavoglurant_files/figure-html/saem-3.png)![](mavoglurant_files/figure-html/saem-4.png)![](mavoglurant_files/figure-html/saem-5.png)![](mavoglurant_files/figure-html/saem-6.png)![](mavoglurant_files/figure-html/saem-7.png)![](mavoglurant_files/figure-html/saem-8.png)![](mavoglurant_files/figure-html/saem-9.png)![](mavoglurant_files/figure-html/saem-10.png)![](mavoglurant_files/figure-html/saem-11.png)![](mavoglurant_files/figure-html/saem-12.png)

### Change error to lognormal

``` r

## Change C15 to be log-normally distributed
fit.lnorm.S.mod <- pbpk %>% model({C15 ~ lnorm(lnorm.err)})
fit.lnorm.S := nlmixr(fit.lnorm.S.mod, dat, est="saem", control=list(print=0),
                      table=list(cwres=TRUE, npde=TRUE))
```

**NOTE:** lognormal distribution AIC/loglik/etc is on normal scale.
Therefore, you can compare the AICs between fit.lnorm and fit.addProp
since they are calculated on the same scale.

In this case you can see that the AIC for the log-normal model is better
than the AIC for the addProp model.
...
![](mavoglurant_files/figure-html/saemLognormalGofs-1.png)![](mavoglurant_files/figure-html/saemLognormalGofs-2.png)![](mavoglurant_files/figure-html/saemLognormalGofs-3.png)![](mavoglurant_files/figure-html/saemLognormalGofs-4.png)![](mavoglurant_files/figure-html/saemLognormalGofs-5.png)![](mavoglurant_files/figure-html/saemLognormalGofs-6.png)![](mavoglurant_files/figure-html/saemLognormalGofs-7.png)![](mavoglurant_files/figure-html/saemLognormalGofs-8.png)![](mavoglurant_files/figure-html/saemLognormalGofs-9.png)![](mavoglurant_files/figure-html/saemLognormalGofs-10.png)![](mavoglurant_files/figure-html/saemLognormalGofs-11.png)![](mavoglurant_files/figure-html/saemLognormalGofs-12.png)

## Piping to FOCEi

You can pipe models from different estimation methods to new estimation
methods.
...
fit.addProp.F := nlmixr(fit.addProp.S, dat, est="focei",
...
![](mavoglurant_files/figure-html/focei-1.png)![](mavoglurant_files/figure-html/focei-2.png)![](mavoglurant_files/figure-html/focei-3.png)![](mavoglurant_files/figure-html/focei-4.png)![](mavoglurant_files/figure-html/focei-5.png)![](mavoglurant_files/figure-html/focei-6.png)![](mavoglurant_files/figure-html/focei-7.png)![](mavoglurant_files/figure-html/focei-8.png)![](mavoglurant_files/figure-html/focei-9.png)![](mavoglurant_files/figure-html/focei-10.png)![](mavoglurant_files/figure-html/focei-11.png)

### Log-normal

``` r

fit.lnorm.F.mod <- fit.addProp.F %>% model({C15 ~ lnorm(lnorm.err)})
fit.lnorm.F := nlmixr(fit.lnorm.F.mod, dat, est="focei",
                      control=list(print=0),
                      table=list(cwres=TRUE, npde=TRUE))
...
![](mavoglurant_files/figure-html/logNormalFocei-1.png)![](mavoglurant_files/figure-html/logNormalFocei-2.png)![](mavoglurant_files/figure-html/logNormalFocei-3.png)![](mavoglurant_files/figure-html/logNormalFocei-4.png)![](mavoglurant_files/figure-html/logNormalFocei-5.png)![](mavoglurant_files/figure-html/logNormalFocei-6.png)![](mavoglurant_files/figure-html/logNormalFocei-7.png)![](mavoglurant_files/figure-html/logNormalFocei-8.png)![](mavoglurant_files/figure-html/logNormalFocei-9.png)![](mavoglurant_files/figure-html/logNormalFocei-10.png)![](mavoglurant_files/figure-html/logNormalFocei-11.png)
...
fit.lnorm.trans := nlmixr(pbpkL, datL, est="saem",
                          control=list(print=0),
